...
/*
   ...
   This file was originally auto-generated, but has since seen numerous manual
   changes. If you regenerate this file using tools then you will need to replay
   these manual changes on this file or else you will completely break the Linux
   ProductionBreakpoints profiler at runtime in subtle and mysterious ways!

   Note: this must be updated every time InstrumentationEngine_api.cpp is updated
   in order to support consumption of these interfaces in non-Windows platforms.
*/
